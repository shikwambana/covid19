...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div fxLayout=\"column wrap\">\r\n    <div class=\"articleHeader\" fxLayout=\"column\" fxLayoutAlign=\"center center\">\r\n        <div class=\"articleHeaderOverlay\">\r\n        <h2 class=\"fadeInDown\">{{article.slug | titlecase}}</h2>\r\n        <h3 class=\"fadeInDown\">{{article.date | date : 'full'}}</h3>\r\n        <div *ngIf=\"!article\">\r\n            <div class=\"lds-ripple\"><div></div><div></div></div>\r\n        </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"articleContainer\" fxLayout=\"row wrap\" >\r\n        <div class=\"article fadeInDown\" fxLayout=\"column wrap\" fxFlex=\"3\">\r\n\r\n            <div *ngIf=\"article\" [innerHtml]=\"article.content.rendered\"></div>\r\n        </div>\r\n        <div class=\"sidebar\" fxLayout=\"column wrap\" fxFlex=\"1\">\r\n            <div class=\"articles\" *ngIf=\"articles\" fxLayout=\"row wrap\" fxLayoutAlign=\"space-evenly center\" fxFlex=\"100\"\r\n                fxFill>\r\n                <div class=\"article\" fxLayout=\"column wrap\" *ngFor=\"let article of articles\"\r\n                    [routerLink]=\"['/article/', article.id, article.slug]\" (click)=\"loadArticle(article)\">\r\n                    <mat-card>\r\n                        <mat-card-content>\r\n\r\n                            <h3>{{article.slug | titlecase}}</h3>\r\n                            <h6>Posted on {{article.date}}</h6>\r\n                            <div>\r\n                                <div [innerHtml]=\"article.excerpt.rendered | slice:0:250\"></div>\r\n                            </div>\r\n\r\n                        </mat-card-content>\r\n\r\n                    </mat-card>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"articlesContainer\" fxLayout=\"column wrap\">\r\n    <div fxLayout=\"row wrap\" fxLayoutAlign=\"center center\" style=\"text-align: center\">\r\n        <h2>Updates from the National Institue of Communicable Disease <a href=\"http://www.nicd.ac.za/\">(NICD)</a></h2>\r\n    </div>\r\n    <div *ngIf=\"!articles\" style=\"margin: 0 auto;text-align: center;\">\r\n        <div class=\"lds-ripple\"><div></div><div></div></div>\r\n    </div>\r\n    <div class=\"articles\" fxLayout=\"row wrap\" fxLayoutAlign=\"space-evenly center\" fxFlex=\"100\" fxFill>\r\n        <div class=\"article\" [routerLink]=\"['/article/', article.id, article.slug]\" [state]=\"{ data: article }\" fxLayout=\"column wrap\" *ngFor=\"let article of articles\" (click)=\"openArticle(article)\">\r\n            <mat-card>\r\n                <mat-card-content>\r\n    \r\n                    <h3>{{article.slug | titlecase}}</h3>\r\n                    <h6>Posted on {{article.date}}</h6>\r\n                    <div>\r\n                        <div [innerHtml]=\"article.excerpt.rendered | slice:0:250\"></div>\r\n                    </div>\r\n    \r\n                </mat-card-content>\r\n    \r\n            </mat-card>\r\n        </div>\r\n    </div>\r\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div>\n    <div class=\"articleHeader\" fxLayout=\"column\" fxLayoutAlign=\"center center\">\n        <div class=\"articleHeaderOverlay\">\n            <h2 class=\"fadeInDown\">South African Stats</h2>\n            <div style=\"display: none;\">\n                <div class=\"lds-ripple\">\n                    <div></div>\n                    <div></div>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <div fxLayout=\"row wrap\" fxLayoutAlign=\"center center\" class=\"graphsContainer\" fxFlex=\"100\">\n        \n        <div fxLayout=\"column\" fxLayoutAlign=\"center center\" class=\"graphContainer\">\n            <div  style=\"max-width: 700px;\"  *ngIf=\"pieChartData\">\n                <h2 style=\"text-align: center;\">Number of Cases per Province</h2>\n                <canvas baseChart [data]=\"pieChartData\" [labels]=\"pieChartLabels\" [colors]=\"pieChartColors\"\n                    [plugins]=\"pieChartPlugins\" [options]=\"pieChartOptions\" [legend]=\"pieChartLegend\"\n                    [chartType]=\"pieChartType\"></canvas>\n            </div>\n\n            <div fxLayout=\"row wrap\" style=\"display: flex; margin: 20px 0;\">\n                <h5 style=\"margin: 14px;\">Chart Type: </h5>\n                <mat-button-toggle-group name=\"fontStyle\" aria-label=\"Font Style\">\n                    <mat-button-toggle [checked]=\"true\" (click)=\"changeProvGraph('bar')\" value=\"line\">Bar Graph\n                    </mat-button-toggle>\n                    <mat-button-toggle (click)=\"changeProvGraph('pie')\" value=\"pie\">Pie Chart</mat-button-toggle>\n                </mat-button-toggle-group>\n            </div>\n        </div>\n\n        <div fxLayout=\"column\" fxLayoutAlign=\"center center\" class=\"graphContainer\">\n\n            <div  style=\"max-width: 700px;\" *ngIf=\"genderChartData\" >\n                <h2 style=\"text-align: center;\">Gender</h2>\n                <canvas baseChart [data]=\"genderChartData\" [labels]=\"genderChartLabels\" [colors]=\"genderChartColors\"\n                    [options]=\"pieChartOptions\" [legend]=\"genderChartLegend\" [chartType]=\"genderChartType\"></canvas>\n            </div>\n        </div>\n    </div>\n\n    <div fxLayout=\"column\" style=\"margin: 30px;\" fxLayoutAlign=\"center center\">\n        <div style=\"max-width: 700px;\" *ngIf=\"lineChartLabels\">\n        <h2 style=\"text-align: center;\">Timeline of New and Total Cases</h2>\n            <canvas baseChart width=\"200\" height=\"200\" [datasets]=\"lineChartData\" [labels]=\"lineChartLabels\"\n                [options]=\"lineChartOptions\" [legend]=\"lineChartLegend\" [chartType]=\"lineChartType\"></canvas>\n        </div>\n        <div fxLayout=\"row wrap\" style=\"display: flex; margin: 20px 0;\">\n            <h5 style=\"margin: 14px;\">Chart Type: </h5>\n            <mat-button-toggle-group name=\"fontStyle\" aria-label=\"Font Style\">\n                <mat-button-toggle [checked]=\"true\" (click)=\"changeGraph('line')\" value=\"line\">Line Graph\n                </mat-button-toggle>\n                <mat-button-toggle (click)=\"changeGraph('bar')\" value=\"bar\">Bar Graph</mat-button-toggle>\n            </mat-button-toggle-group>\n        </div>\n    </div>\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"infoContainer\">\n    <div class=\"articleHeader\" fxLayout=\"column\" fxLayoutAlign=\"center center\">\n        <div class=\"articleHeaderOverlay\">\n            <h2 class=\"fadeInDown\">Information on Corvid-19</h2>\n            <div style=\"display: none;\">\n                <div class=\"lds-ripple\">\n                    <div></div>\n                    <div></div>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- <div class=\"casesTitle\" fxLayout=\"row wrap\" style=\"text-align: center;\" *ngIf=\"cases\">\n        <div fxLayout=\"column wrap\" fxFlex=\"1\">\n            <h2>Global</h2>\n            <p>Number of Reported Cases</p>\n        </div>\n        <div fxLayout=\"column wrap\"  fxFlex=\"1\">\n            <div class=\"caseNumber\">{{cases.cases}}</div>\n            <p>Number of Deaths: </p>\n            <p>Number of Deaths: {{cases.recovered}}</p>\n        </div>\n    </div> -->\n    <div fxLayout=\"row wrap\" style=\"display: flex; flex-wrap: wrap; justify-content: center;\" class=\"numbers\" fxFlex=\"100\">\n        <div fxFlex=\"50\" fxLayout=\"column wrap\" class=\"numberCard\"> \n            <p>Global Cases</p>\n            <h1>{{cases.cases}}</h1>\n        </div>\n        <div fxLayout=\"column wrap\" fxFlex=\"50\"  class=\"numberCard\">\n            <p>Recoveries</p>\n            <h2>{{cases.recovered}}</h2>\n        </div>\n        <div fxLayout=\"column wrap\" fxFlex=\"50\"  class=\"numberCard\">\n            <p>Deaths</p>\n            <h2>{{cases.deaths}}</h2>\n        </div>\n\n    </div>\n    <mat-accordion>\n        <mat-expansion-panel>\n          <mat-expansion-panel-header>\n            <mat-panel-title>\n                What is Corvid-19?\n            </mat-panel-title>\n          </mat-expansion-panel-header>\n      \n          <p>Coronavirus disease (COVID-19) is an infectious disease caused by a new virus.\n            The disease causes respiratory illness (like the flu) with symptoms such as a cough, fever, and in more\n            severe cases, difficulty breathing. You can protect yourself by washing your hands frequently, avoiding\n            touching your face, and avoiding close contact (1 meter or 3 feet) with people who are unwell.</p>\n\n        </mat-expansion-panel>\n\n        <mat-expansion-panel>\n            <mat-expansion-panel-header>\n              <mat-panel-title>\n                Symptoms\n              </mat-panel-title>\n            </mat-expansion-panel-header>\n        \n            <p>People may be sick with the virus for 1 to 14 days before developing symptoms. The most common symptoms\n                of coronavirus disease (COVID-19) are fever, tiredness, and dry cough. Most people (about 80%) recover\n                from the disease without needing special treatment.\n            </p>\n            <p>\n                More rarely, the disease can be serious and even fatal. Older people, and people with other medical\n                conditions (such as asthma, diabetes, or heart disease), may be more vulnerable to becoming severely\n                ill.\n            </p>\n            <p>\n                People may experience:\n            </p>\n            <ul>\n                <li>cough</li>\n                <li>fever</li>\n                <li>tiredness</li>\n                <li>difficulty breathing (severe cases)</li>\n            </ul>\n          </mat-expansion-panel>\n\n          <mat-expansion-panel>\n            <mat-expansion-panel-header>\n              <mat-panel-title>\n                  Prevention\n              </mat-panel-title>\n            </mat-expansion-panel-header>\n            \n            <div *ngFor=\"let item of prevention\">\n                <h4>{{item.title}}</h4>\n                <p>{{item.action}}</p>\n                <p><strong>Reason: </strong> {{item.reason}}</p>\n            </div>\n  \n          </mat-expansion-panel>\n<!-- \n          <mat-expansion-panel>\n            <mat-expansion-panel-header>\n              <mat-panel-title>\n                  Videos\n              </mat-panel-title>\n            </mat-expansion-panel-header>\n        \n  \n          </mat-expansion-panel> -->\n\n          <mat-expansion-panel>\n            <mat-expansion-panel-header>\n              <mat-panel-title>\n                  Links\n              </mat-panel-title>\n            </mat-expansion-panel-header>\n        \n            <a href=\"http://www.nicd.ac.za/\" target=\"_blank\">National Institute of Communicable Diseases</a><br>\n            <a href=\"https://www.who.int/emergencies/diseases/novel-coronavirus-2019\" target=\"_blank\">World Health Organisation</a>\n          </mat-expansion-panel>\n\n\n          \n    </mat-accordion>\n\n    \n\n</div>");
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getNICDArcticles = function () {
    ...
    ApiService.prototype.getCoronaData = function () {
...
/* harmony import */ var _articles_articles_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./articles/articles.component */ "./src/app/articles/articles.component.ts");
...
/* harmony import */ var _graphs_graphs_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./graphs/graphs.component */ "./src/app/graphs/graphs.component.ts");
...
var ArticleComponent = /** @class */ (function () {
    function ArticleComponent(router, api, activatedRoute) {
        this.router = router;
        this.api = api;
    ...
    ArticleComponent.prototype.getArticle = function (id) {
        var _this = this;
        this.api.getArticle(id).subscribe(function (res) {
            _this.article = res;
            console.log(res);
        });
    };
    ArticleComponent.prototype.loadArticle = function (article) {
        this.article = article;
        window.scroll(0, 0);
    };
    ArticleComponent.prototype.fetchArticles = function () {
        var _this = this;
        this.api.getNICDArcticles().subscribe(function (res) {
            _this.articles = res;
        }, function (err) {
            console.log(err);
        });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".articles {\n  display: -webkit-box;\n  display: flex;\n  flex-wrap: wrap;\n}\n\n.article {\n  margin: 10px;\n  -webkit-box-flex: 1;\n          flex: 1 0 21%;\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var ArticlesComponent = /** @class */ (function () {
    ...
    ArticlesComponent.prototype.openArticle = function (article) {
        console.log(article);
    };
...
/***/ "./src/app/graphs/graphs.component.scss":
/*!**********************************************!*\
  !*** ./src/app/graphs/graphs.component.scss ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".graphsContainer {\n  display: -webkit-box;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-around;\n  margin: 30px;\n}\n\n.graphContainer {\n  -webkit-box-flex: 1;\n          flex: 1;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var GraphsComponent = /** @class */ (function () {
    function GraphsComponent(api) {
        ...
        this.provinces = [];
        this.listOfProvinces = ['GP', 'KZN', 'WC', 'LP', 'EC', 'FS', 'NC', 'NW', 'MP', 'UNK'];
        this.gender = [{ name: 'Male', value: 'male' }, { name: 'Female', value: 'female' }, { name: 'Not Specified', value: 'not specified' }];
        //==================================================================================
        // Province chart
        this.pieChartLabels = [];
        this.pieChartData = [];
    ...
    GraphsComponent.prototype.extractData = function () {
        var _this = this;
        this.api.getConfirmedCaseTimeLine().subscribe(function (res) {
            _this.csvJSON(res);
        });
    };
    // convert csv to json
    GraphsComponent.prototype.csvJSON = function (csv) {
        var lines = csv.split("\n");
        var result = [];
    ...
    GraphsComponent.prototype.sortByProvince = function () {
        var _this = this;
        this.listOfProvinces.forEach(function (prov) {
            var item = _this.timelineCases.filter(function (obj) {
        ...
        this.pieChartLabels = this.provinces.map(function (res) {
            return res['label'];
        });
        this.pieChartData = this.provinces.map(function (res) {
            return res['y'];
        });
        this.gender.forEach(function (gender) {
            var item = _this.timelineCases.filter(function (obj) {
            ...
            _this.genderType.push(obj);
        });
        this.genderChartLabels = this.genderType.map(function (res) {
            return res['label'];
        });
        this.genderChartData = this.genderType.map(function (res) {
            return res['y'];
        });
        console.log(this.genderType);
    };
    GraphsComponent.prototype.buildData = function () {
        var _this = this;
        this.timelineCases.forEach(function (info) {
            var item = _this.timelineCases.filter(function (obj) {
            ...
            if (!_this.data.some(function (info) { return info['label'] === obj['label']; })) {
                _this.data.push(obj);
            }
        });
        ...
        this.lineChartLabels = this.confirmedCases.map(function (res) {
            return res['label'];
        });
        this.lineChartData[0]['data'] = this.confirmedCases.map(function (res) {
            return res['y'];
        });
        this.lineChartData[1]['data'] = this.data.map(function (res) {
            return res['y'];
        });
        console.log(this.lineChartLabels, this.lineChartData);
    };
    GraphsComponent.prototype.changeGraph = function (type) {
        this.lineChartType = type;
    };
    GraphsComponent.prototype.changeProvGraph = function (type) {
        this.pieChartType = type;
    };
    GraphsComponent.ctorParameters = function () { return [
        { type: _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
    ]; };
    GraphsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./graphs.component.scss */ "./src/app/graphs/graphs.component.scss")).default]
        })
    ], GraphsComponent);
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.searchCountry.valueChanges
            .subscribe(function (userInput) { _this._filter(userInput); });
    };
    HomeComponent.prototype._filter = function (value) {
        var filterValue = value.toLowerCase();
        this.filteredOptions = this.countries.filter(function (option) { return option.country.toLowerCase().includes(filterValue); });
        console.log(value, this.filteredOptions);
    };
    HomeComponent.prototype.getInfo = function () {
        var _this = this;
        this.api.getCoronaData().subscribe(function (res) {
            _this.countries = res;
            console.log(res);
            // this.updated = res['statistic_taken_at']
            if (sessionStorage.getItem('country')) {
                _this.showCountryData(sessionStorage.getItem('country'));
            }
            else {
    ...
    HomeComponent.prototype.showCountryData = function (selected) {
        this.data = this.countries.filter(function (country) {
    ...
    HomeComponent.prototype.hideKeyboard = function (element) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("mat-chip-list-wrapper {\n  display: -webkit-inline-box !important;\n  display: inline-flex !important;\n  padding: 30px 0;\n}\n\nh1, h2, h3, h4 {\n  margin: 0 !important;\n}\n\n.numbers p {\n  margin: 0 !important;\n}\n\n.numberCard {\n  background-color: #00838f;\n  color: white;\n  padding: 20px;\n  box-shadow: 5px 5px 10px 1px #4fb3bf;\n  margin: 10px;\n  min-width: 130px;\n}\n\nmat-expansion-panel {\n  margin: 0px 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var InfoComponent = /** @class */ (function () {
    ...
    InfoComponent.prototype.getNumbers = function () {
        var _this = this;
        this.api.getAllCases().subscribe(function (res) {
            _this.cases = res;
            console.log(res);
        });
    };
...
module.exports = __webpack_require__(/*! C:\Users\Neutrinos\Documents\corvid19\src\main.ts */"./src/main.ts");
